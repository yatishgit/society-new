...
import com.adapter.PersonalPendingIssuesRecyclerViewAdapter;
...
public class PersonalPendingIssuesFragment extends Fragment implements MyDialogFragmentListener{

    public RecyclerView mRecyclerView;
    public RecyclerView.Adapter mAdapter;
    public RecyclerView.LayoutManager mLayoutManager;
    private static String LOG_TAG = "pendingissuesRecycler";
    public ArrayList<HelpDeskPersonal> results = new ArrayList<>();
    URL url = new URL();
    RequiredFunction rf = new RequiredFunction();
    TextView empty_msg;

    public PersonalPendingIssuesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pending_issues, container, false);
        empty_msg = (TextView) rootView.findViewById(R.id.empty_visitors);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.pending_issues_recyclerview);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        Log.d("res jhj", results.toString());
        mAdapter = new PersonalPendingIssuesRecyclerViewAdapter(results, getContext(), getActivity(),mAdapter);
    ...
    public void getObject(String response) {
        ...
        try {
            ...
            if (!check.equalsIgnoreCase("failure")) {
                ...
                empty_msg.setText(R.string.no_pending_issues);
            }
    ...
    public void onReturnValue(String foo) {
        if(foo.equalsIgnoreCase("Delete")) {
            mAdapter = new PersonalPendingIssuesRecyclerViewAdapter(results, getContext(), getActivity(), mAdapter);
            mRecyclerView.setAdapter(mAdapter);
        }
    }
