...
import com.adapter.SocietyPendingIssuesRecyclerViewAdapter;
...
public class SocietyPendingIssuesFragment extends Fragment {

    public RecyclerView mRecyclerView;
    public RecyclerView.Adapter mAdapter;
    public RecyclerView.LayoutManager mLayoutManager;
    private static String LOG_TAG = "pendingissuessocietyRV";
    public ArrayList<HelpDeskSociety> results = new ArrayList<>();
    URL url = new URL();
    RequiredFunction rf = new RequiredFunction();
    TextView empty_msg;

    public SocietyPendingIssuesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pending_issues_society, container, false);
        empty_msg = (TextView) rootView.findViewById(R.id.empty_visitors);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.pending_issues_recyclerview_society);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);

        Log.d("res jhj", results.toString());
        mAdapter = new SocietyPendingIssuesRecyclerViewAdapter(results, getContext(), getActivity());
        ...
        try {
            ...
            if (!check.equalsIgnoreCase("failure")) {
                ...
                while(iterator.hasNext()){
                    ...
                    if (helpDeskSociety.getResolvedStatus().equalsIgnoreCase("0")){
